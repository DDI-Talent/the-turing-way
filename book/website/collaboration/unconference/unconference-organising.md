...
beforehand:
comms beforehand
people gather, grassroot encouragement (whispering)
encouraging people to suggest tiles

how to decide rooms/spaces based on audience size
pitching (optional) <- Kim?


timetable and events
digital and analogue ways to create timetable 
stationary
digital collaboration tools
different type of participation (suggest, attend, support)
types of slots (presentation, discussion, panel, etc) <- Leo?



aligning the program with other activities (timeslots, rooms, )
once it's happening
managemen
guidelines of how to participate <- Rhian

timekeeping and stewardship
roles and how many people do you need?


after
comms/advertising on the day: slack /signposting
aftercare and keeping the community/connection (optional)
cleaning up
